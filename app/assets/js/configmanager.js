...
/**
 * Stub to update offline account.
 * 
 * @param {string} uuid The uuid of the authenticated account.
 * @param {string} accessToken The new Access Token.
 * 
 * @returns {Object} The authenticated account object created by this action.
 */
exports.updateOfflineAuthAccount = function (uuid) {
    config.authenticationDatabase[uuid].accessToken = ''
    config.authenticationDatabase[uuid].type = 'offline' // For gradual conversion.
    return config.authenticationDatabase[uuid]
}

/**
 * TODO: Debug this offline auth
